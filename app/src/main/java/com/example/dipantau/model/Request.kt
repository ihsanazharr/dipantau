 ...
 */
data class JoinHimpunanRequest(
...
/**
 * Request untuk update status anggota
 */
...
/**
 * Request untuk update peran anggota
 */
...
/**
 * Request untuk update status kegiatan
 */
data class UpdateActivityStatusRequest(
    @SerializedName("status")
    val status: String
)
...
// Request untuk membership baru (langsung di User)
